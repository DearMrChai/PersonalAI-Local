...
├── backend/
│   ├── models/
│   └── 此处放你的模型.txt                      # 放gguf模型的位置
│   ├── src/
│   │   ├── config
│   │   │   └── swagger.js                     # swagger配置
│   │   ├── controllers/
│   │   │   ├── character.controllers.js       # 角色控制器
│   │   │   ├── chat.controller.js             # 聊天控制器
│   │   │   └── tag.controllers.js             # 标签控制器 
│   │   ├── middleware/
│   │   │   └── validate.js                    # 参数校验（暂时没用上）
│   │   ├── models/
│   │   │   ├── entities/
│   │   │   │   ├── Character.js               # 角色模型
│   │   │   │   ├── CharacterTag.js            # 角色标签模型
│   │   │   │   ├── ChatMessage.js             # 聊天消息模型
│   │   │   │   ├── ChatSession.js             # 会话模型
│   │   │   │   └── Tag.js                     # 标签模型
│   │   │   ├── repositories/
│   │   │   │   ├── CharacterRepository.js     # 角色模型
│   │   │   │   ├── CharacterTagRepository     # 角色标签模型
│   │   │   │   ├── ChatMessageRepository.js   # 聊天消息模型
│   │   │   │   ├── ChatSessionRepository.js   # 会话模型
│   │   │   │   └── TagRepository.js           # 标签模型
│   │   │   ├── schemas/
│   │   │   │   └── tag.schema.js              # 标签验证规则（暂时没用）
│   │   │   ├── connection.js                  # 数据库连接
│   │   │   ├── index.js                       # 数据库连接
│   │   │   └── migrate.js                     # 数据库迁移(暂时没用)
│   │   ├── routes/
│   │   │   ├── character.routes.js            # 角色服务
│   │   │   ├── chat.routes.js                 # 聊天服务
│   │   │   ├── chatRecord.routes.js           # 聊天记录服务(作废)
│   │   │   ├── role.routes.js                 # 角色服务
│   │   │   ├── tag.routes.js                  # 标签服务
│   │   │   └── user.routes.js                 # 用户服务
│   │   ├── services/
│   │   │   ├── chat/
│   │   │   │   ├── context/
│   │   │   │   │   └── contextManager.js      # 会话上下文管理
│   │   │   │   ├── llm/
│   │   │   │   │   ├── providers/
│   │   │   │   │   │   └── llama-provider.js  # llama38配置之类的
│   │   │   │   │   ├── index.js               # LLM实现
│   │   │   │   │   └── llm.interface.js       # LLM接口
│   │   │   │   └── prompt/
│   │   │   │       └── promptBuilder.js       # 提示词构建
│   │   │   ├── character.service              # 角色服务
│   │   │   ├── chat.service.js                # 聊天服务
│   │   │   ├── chatRecord.service.js          # 聊天记录服务（旧版本 废弃）
│   │   │   ├── role.service                   # 角色服务
│   │   │   ├── tag.service.js                 # 标签服务
